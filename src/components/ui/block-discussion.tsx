...
import { commentPlugin } from '@/components/organisms/Editor/plugins/comment-kit';
import {
  type TDiscussion,
  discussionPlugin,
} from '@/components/organisms/Editor/plugins/discussion-kit';
import { suggestionPlugin } from '@/components/organisms/Editor/plugins/suggestion-kit';
