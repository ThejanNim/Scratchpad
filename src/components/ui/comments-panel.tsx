    ...
    replies: [
      {
        ...
        content:
          "I can provide the survey data from last month. We had 247 responses with some great insights.",
    ...
    replies: [
      {
        ...
        content:
          "I've added the metrics to the document. The 40% stat is now included with proper citations.",
              ...
              <div className="p-4 space-y-4">
                {filteredComments
                  ...
                  .map((comment) => (
                    <Card
                      key={comment.id}
                      className={`relative ${getStatusColor(comment.status)}`}
                    >
                      {comment.isPinned && (
