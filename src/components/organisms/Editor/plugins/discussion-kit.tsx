...
import type { TComment } from '@/components/organisms/Editor/elements/comment';

import { createPlatePlugin } from 'platejs/react';

import { BlockDiscussion } from '@/components/organisms/Editor/elements/block-discussion';
