...
import type { TComment } from '@/components/organisms/Editor/Comment/comment';

import { createPlatePlugin } from 'platejs/react';

import { BlockDiscussion } from '@/components/organisms/Editor/Discussion/block-discussion';
