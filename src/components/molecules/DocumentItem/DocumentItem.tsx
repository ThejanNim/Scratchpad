...
export interface DocumentItemProps {
    ...
    level?: number;
    isLoading: boolean;
    handleDocumentAction: (documentId: string, action: "rename" | "duplicate" | "delete") => void;
}

export default function DocumentItem({ document, level = 0, isLoading, handleDocumentAction }: DocumentItemProps) {
    return (
        <SidebarMenuSubItem>
